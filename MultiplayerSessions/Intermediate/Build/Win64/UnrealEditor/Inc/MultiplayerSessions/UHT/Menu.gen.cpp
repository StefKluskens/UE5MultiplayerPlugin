...
// End Cross Module References
	...
	DEFINE_FUNCTION(UMenu::execMenuSetup)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->MenuSetup(Z_Param_numOfPublicConnections,Z_Param_matchType,Z_Param_lobbyPath);
		P_NATIVE_END;
	}
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMenu_OnCreateSession_Statics::Function_MetaDataParams[] = {
		{ "Comment", "/*\n\x09* Callbacks for custom delegates on the MultiplayerSessionsSubsystem\n\x09*/" },
		{ "ModuleRelativePath", "Public/Menu.h" },
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMenu_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UMenu_MenuSetup, "MenuSetup" }, // 3275391
		{ &Z_Construct_UFunction_UMenu_OnCreateSession, "OnCreateSession" }, // 2975682942
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMenu_Statics::NewProp_HostButton_MetaData[] = {
		{ "BindWidget", "" },
		{ "Comment", "/*\n\x09* This UPROPERTY meta will link the button from the widget to this variable\n\x09* Variable needs the exact same name as the items in the widget blueprint!\n\x09*/" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Menu.h" },
		{ "ToolTip", "* This UPROPERTY meta will link the button from the widget to this variable\n* Variable needs the exact same name as the items in the widget blueprint!" },
	};
#endif
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MenuSystem_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMenu, UMenu::StaticClass, TEXT("UMenu"), &Z_Registration_Info_UClass_UMenu, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMenu), 3079352846U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MenuSystem_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_622014095(TEXT("/Script/MultiplayerSessions"),
